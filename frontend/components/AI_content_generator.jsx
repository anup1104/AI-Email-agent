...
function AI_content_generator() {
    ...
    const handleGeneratePromt = async () => {
        const response = await fetch("https://ai-email-agent-r100.onrender.com/api/generate-email", {
            method: "POST",
            headers: {
    ...
    const handleSendEmail = async () => {
        ...
        const response = await fetch("https://ai-email-agent-r100.onrender.com/api/send-email", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
